    ...
    <section>
      <div className="container mx-auto">
        <div className="relative">
          <div className=" bg-[#181d29] shadow-m absolute left-[50%] translate-x-[-50%] top-[-50px] rounded-[5px] element-center flex-col  w-[865px] min-h-[275px]  max-w-full text-text100 text-center p-[30px]">
            ...
            <form className="w-full flex justify-between items-center flex-wrap md:px-[60px] gap-[30px]">
              <input
                ...
                className="md:flex-1 w-full  h-[50px] rounded-[30px] pl-[30px] outline-none border-none text-sm text-[#000] font-medium"
              />
              <button
                type="submit"
